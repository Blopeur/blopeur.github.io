...
But most of those are done under cross-licensing agreement from AMD. And emulation is almost non-existent. Emulation could at least ensure compatibility and help the ARM ecosystem which has seen vast improvements due to a more significant number of implementers: Apple, Huawei, Qualcomm, Nvidia, Samsung, ARM, Applied Micro and Cavium.
